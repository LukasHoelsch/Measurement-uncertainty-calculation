%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% plot_MotorLossMech.m %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Visualization of the calculated mechanical motor loss.
%
...
if plot_enable == 1
    ...
    fig.fh(end+1) = figure('NumberTitle', 'off', 'name', 'MotorLossMech', 'Resize', 'off', 'RendererMode', 'manual');
    ...
    [~,h] = contourf(plot_n,plot_T_calc,plot_motor_P_loss_mech)
    u = colorbar
    u.FontSize = 10;
    ...
    u.Ticks = [0,500,1000,1500,2000];
    u.TickLabels = {'0','500','1000','1500','2000'};
...
%
    ...
    %
    AdjustSubplot(fig,0.05,[0.14 0.17 0.76 0.95],[2]);
    %
