%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% plot_sensitivity_current.m %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Visualization of the sensetitiy coefficient for the current measurement.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if plot_enable == 1
    ...
    fig.fh(end+1) = figure('NumberTitle', 'off', 'name', 'sensitivity_current', 'Resize', 'off', 'RendererMode', 'manual');
    ...
    [~,h] = contourf(plot_n,plot_T_calc,abs(plot_c_I_SM))
    u = colorbar
    % clim([0.9166 0.9550]);
    u.FontSize = 10;
    ...
    u.Label.FontSize = 10;
    u.Label.String = '$c_\mathrm{I}$';
    % u.Limits = [0.9,0.99];
    ZTicks = [0,0.02,0.04];
    ZTickLabel={'0','0.02','0.04'};
    u.Ticks = ZTicks;
    ...
    set(fig.sp(end), 'TickLabelInterpreter', 'Latex');
    [~,h] = contourf(plot_n,plot_T_calc,abs(plot_c_I_MM))
    u = colorbar
    % clim([0.9166 0.9550]);
    ...
    ZTicks = [0.0062,0.0063,0.0064];
    ZTickLabel={'6.2 ','6.3 ','6.4 '};
    u.Ticks = ZTicks;
    u.TickLabels = ZTickLabel;
    ...
    %clim([0,max_abs]);
     ...
     if save_plot ==1
            FigName = ['sensitivity_current.pdf'];
