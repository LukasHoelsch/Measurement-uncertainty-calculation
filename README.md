...
$$u_{\mathrm{c,\eta}} = \sqrt{{\left(\frac{\partial \eta_{\mathrm{ED}}}{\partial P_{\mathrm{mech}}}\right)}^2 u_{\mathrm{c,mech}}^2 + {\left(\frac{\partial \eta_{\mathrm{ED}}}{\partial P_{\mathrm{DC}}}\right)}^2 u_{\mathrm{c,DC}}^2 } $$
